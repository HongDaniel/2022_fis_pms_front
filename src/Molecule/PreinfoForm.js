...
const PreinfoForm = (props) => {
    ...
    console.log(props.selectedRow.f_location);
    return (
        <Modal>
            ...
            <div id={"modal"}>
                <div className={"info"}>
                    ...
                    <InputContainer id={"보존기간"} width={"150px"} type={"select"}
                                    contents={["1년","3년","5년","10년","20년", "30년", "영구"]} defaultValue={props.selectedRow.f_kperiod} handleChange={props.handleChange}/>
                    <InputContainer id={"구축여부"} width={"150px"} type={"select"}
                                    contents={["구축", "비구축"]} handleChange={props.handleChange}/>
                ...
                <div className={"info"}>
                    ...
                    <InputContainer id={"보존장소"} width={"200px"} type={"select"}
                                    contents={["기록관", "전문관리기관"]} handleChange={props.handleChange}/>
                    <InputContainer id={"문서유형"} width={"200px"} type={"select"}
                                    contents={["일반문서", "도면류","사진-필름류","녹음-동영상류","카드류"]} handleChange={props.handleChange}/>
