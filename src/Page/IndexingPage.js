        ...
        <Container>
            ...
            <MainBox height={'1140px'}>
                ...
                <div style={{display: 'flex', flexDirection: 'row'}}>
                            ...
                            <div style={{margin: '50px 0 0 15px'}}>
                                ...
                                <Box width='100%' height='350px' backgroundColor={Style.color3}>
                                    <Table loading={boxLoading} isRowSelectable={true} selectionModel={selectionBoxModel} setSelectionModel={setSelectionBoxModel}
                                           width='100%' height='330px' headerBG={Style.color2} cellBG={Style.color1} rows={boxRows}
                                           columns={boxColumns}/>
                                </Box>
                            </div>
                            <div style={{margin: '50px 0 0 15px'}}>
                    ...
                    <div style={{width: '46%'}}>
                        <div style={{margin: '50px 0 0 15px'}}>
                            <Box width='96%' height='140px' backgroundColor={Style.color3}>
                                <InfoContainer>
                        ...
                        <div style={{margin: '20px 0 0 15px'}}>
                            <Box width='96%' height='990px' backgroundColor='white'>
                                <Box width='98%' height='100px' backgroundColor= {Style.color3}>
                                    {currentTab !== 1 &&
